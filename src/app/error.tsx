    ...
    <div style={{ minHeight: '70vh', display: 'grid', placeItems: 'center', padding: 24 }}>
      <div style={{ maxWidth: 440, textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center', marginTop: 16 }}>
          <button
            onClick={() => reset()}
            style={{ background: '#1f7a5c', color: '#fff', border: 0, borderRadius: 8, padding: '10px 16px', fontWeight: 600, cursor: 'pointer' }}
          >
            Réessayer
          </button>
          <button
            onClick={() => location.reload()}
            style={{ background: 'transparent', color: '#667085', border: '1px solid #e4e7ec', borderRadius: 8, padding: '10px 16px', cursor: 'pointer' }}
          >
            Recharger la page
          </button>
        </div>
